...
When you use the contact form or otherwise reach out, we collect the details you
provide, such as your name, email address, company, and message. Like most
websites, our servers and analytics also record technical data automatically,
such as your IP address, browser type, referring pages, and the pages you view.
We use cookies and similar technologies for essential functions, such as
remembering your theme preference, and, where enabled, for analytics.

## 2. How we use information

We use personal information to respond to your inquiries and provide support, to
operate, secure, and improve the Site, to understand in aggregate how the Site
is used, and to comply with our legal obligations. We do not sell your personal
information or share it for third-party marketing.

## 3. How we share information

We share personal information with service providers that process it on our
behalf, such as hosting, email, and analytics providers, under confidentiality
obligations; when required by law or to protect our rights, safety, or property;
